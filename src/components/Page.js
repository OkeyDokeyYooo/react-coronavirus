...
class Page extends Component {
    ...
    componentDidMount() {
        ...
        const requestForToday = Axios.get(
            "https://api.covid19.hackhub.cn/entries/" + today
        );
        // const requestForYesterday = Axios.get("http://18.218.58.203:8000/entries/" + yesterday);
        const requestForTotal = Axios.get(
            "https://api.covid19.hackhub.cn/entries/"
        );
            ...
            Axios.all([requestForToday, requestForTotal])
                .then(
                    Axios.spread((...responses) => {
                        ...
                        const pastAMonthData = requestForTotal.data.filter(
                            (data) => {
                        ...
                        pastAMonthData.map((data) => {
                            let currentData = this.extractData(
                                data,
                                this.state.label
                            );
                        ...
                        const yesterdayData =
                            requestForTotal.data[
                                requestForTotal.data.length - 2
                            ];
                        // console.log(yesterday);

                        this.props.getUpdate(
                            moment(requestForToday.data.updatedAt)
                        ...
                        this.setState({
                            ...
                            summary: summary,
                            diff: diff,
                            updatedTime: moment(requestForToday.data.updatedAt)
                                .tz("America/Vancouver")
                ...
                .then(this.setState({ loadingDone: true }))
                .catch((errors) => {
                    console.log(errors);
                });
        }, 2000);
                                ...
                                {this.state.summary && (
                                    <div className="inner-container">
                                        ...
                                        <div className="line-chart">
                                            <LineChart
                                                totalCasesArray={
                                                    this.state.CasesArray
                                                }
                                                totalDeathArray={
                                                    this.state.DeathArray
                                                }
                                                totalRecoveredArray={
                                                    this.state.RecoveredArray
                                                }
                                                datePeriod={
